"""General-purpose training script for Generative Shadow Removal (GSR) model.

This script is used to train the shadow removal model. It supports various models and datasets.
...
Example:
    Train the GSR model:
        python train_GSR.py --dataroot ./datasets/shadow_data --name AISD_GSR -- dataroot RS_Synshadow/your dataset --model GSR --dataset_mode HEI_aligned
...
if __name__ == "__main__":
    ...
    opt.dataset_mode = "HEI_aligned"  # Dataset mode for shadow removal
    opt.netG = "UnetFusion"  # Generator network type
    opt.model = "GSR"  # Model type
